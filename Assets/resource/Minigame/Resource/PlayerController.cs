...
{   public GameObject[] childlist; 
    ...
    public IEnumerator Dig()
    {
        ...
        if (Input.GetKeyDown(KeyCode.C) && canAttack && (Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.LeftArrow)))
        {
            ...
            {
                Vector3Int playerGridPosition = tilemap.WorldToCell(transform.position + Vector3.right);
                Vector3Int cellPosition = tilemap.WorldToCell(transform.position + Vector3.right);
                Vector3 cellCenter = tilemap.GetCellCenterWorld(cellPosition);
                TileBase tile = tilemap.GetTile(playerGridPosition);
            ...
            {
                Vector3Int playerGridPosition = tilemap.WorldToCell(transform.position + Vector3.left);
                Vector3Int cellPosition = tilemap.WorldToCell(transform.position + Vector3.left);
                Vector3 cellCenter = tilemap.GetCellCenterWorld(cellPosition);
